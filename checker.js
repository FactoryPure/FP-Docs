const validateEDIParserResult = (object, model, map, documentType) => {
  ...
  rest: {
    ...
    guessed: {
      ...
      stressed: {
        position: 1, 
        segment: "N1",
        position: { position: 1, segment: "N1"}, 
        segment: { position: 1, segment: "N1"},
...
console.log(validateEDIParserResult(testObject, testModel, testMap, "TestDoc"))