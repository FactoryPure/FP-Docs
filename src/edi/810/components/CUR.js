...
export default function CUR() {
    return (
        <div id="cur" className="text-offwhite rounded-[4px] p-[32px] shadow-small bg-darkaccent mb-[32px]">
            <h2 className="text-offwhite border-b pb-[8px] font-bold text-[20px] leading-[1] mb-[16px]">CUR Segment</h2>
            <p className="text-offwhite mb-[16px]">To specify the currency (dollars, pounds, francs, etc.) used in a transaction</p>
