export default function MSG() {
    return (
        <div id="msg" className="text-offwhite rounded-[4px] p-[32px] shadow-small bg-darkaccent">
            <h2 className="text-offwhite border-b pb-[8px] font-bold text-[20px] leading-[1] mb-[16px]">MSG Segment</h2>
            <p className="text-offwhite mb-[16px]">To specify free form notes about the order.</p>
            ...
            <div className="text-offwhite grid grid-cols-[1fr_1fr_200px_1fr_1fr_1fr_1fr_1fr] gap-x-[16px] mb-[32px]">
                ...
                <div className="text-offwhite grid grid-cols-[1fr_1fr_200px_1fr_1fr_1fr_1fr] gap-x-[16px] col-span-full pb-[4px] mb-[8px] border-b border-darkgrey">
                    <div>MSG01</div>
                    <div>933</div>
                    <div>Free-Form Message Text</div>
                    <div>M</div>
                    <div>AN</div>
                    <div>1/264</div>
                    <div></div>
