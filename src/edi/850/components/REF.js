export default function REF() {
    return (
        <div id="ref" className="text-offwhite rounded-[4px] p-[32px] shadow-small bg-darkaccent mb-[16px]">
            <h2 className="text-offwhite border-b pb-[8px] font-bold text-[20px] leading-[1] mb-[16px]">REF Segment</h2>
            <p className="text-offwhite mb-[16px]">To provide FactoryPure's shipping account number.</p>
