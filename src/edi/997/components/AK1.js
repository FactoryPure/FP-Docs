...
export default function AK1() {
    return (
        <div id="ak1" className="text-offwhite rounded-[4px] p-[32px] shadow-small bg-darkaccent mb-[32px]">
            <h2 className="text-offwhite border-b pb-[8px] font-bold text-[20px] leading-[1] mb-[16px]">AK1 Segment</h2>
            <p className="text-offwhite mb-[16px]">To start acknowledgment of a functional group</p>
            ...
            <div>
                <p>Notes:</p>
                <p>1. AK101 is the functional ID found in the GS segment (GS01) in the functional group being acknowledged.</p>
                <p>2. AK102 is the functional group control number found in the GS segment in the functional group being acknowledged.</p>
            </div>
        </div>
    )
}