    ...
    return (
        <div id="as2">
            ...
            <p className="text-offwhite mb-[16px]">
                We currently only support EDI using the AS2 protocol over http. Our suppliers will need to supply and
                receive/store a self-signed x509 certificate for signing, encryption, and decryption.
            </p>
            ...
            <div className="grid grid-cols-2 mb-[16px] border-x border-darkgrey">
                <div className="col-span-full grid grid-cols-2 p-[8px] border-b border-t border-darkgrey">
                    ...
                    <p className="text-offwhite">http(s)://edi.fpdash.com</p>
                </div>
            ...
            <p className="text-offwhite">
                If you need to trade, replace, or update a certificate please contact us to set up a meeting.
            </p>
        </div>
    )
}
