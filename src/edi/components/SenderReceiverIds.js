export default function SenderReceiverIds() {
    return (
        <div id="ids">
            ...
            <p className="text-offwhite mb-[8px]">We prefer a mutually defined id so we can make distinctions between test and production messages. However, you may also use your DUNS number or telepohne number.</p>
